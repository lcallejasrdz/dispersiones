...
use App\Http\Requests\SimpleMovement as MasterRequest;
...
class SimpleController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('new-movement/simple', compact($this->compact, 'netx_movement', 'companies'));
    }
    ...
    public function store(MasterRequest $request)
    {
        ...
        // Add Entries
        if(isset($request->entry_company)){
