...
<hr/>
<form id="form-create" class="row g-3 needs-validation" method="POST" action="{{ route('following.direct_finishing_store', ['id' => $movement->id]) }}" enctype="multipart/form-data">
