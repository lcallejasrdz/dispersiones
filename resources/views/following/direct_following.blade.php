...
@else
    <form id="form-create" class="row g-3 needs-validation" method="POST" action="{{ route('following.direct_following_store', ['id' => $movement->id]) }}">
...
@section("script")
    ...
    <script>
        ...
        $('#submit-btn').click(function(){
            ...
            if((dispersion_total == 0 || dispersion_total == '' || dispersion_total == null) || (dispersion_total != output_total))
            {
                var alert = '<div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">';
                    alert += '<div class="d-flex align-items-center">';
                        alert += '<div class="font-35 text-white"><i class="bx bxs-message-square-x"></i>';
                        ...
                        alert += '<div class="ms-3">';
                            ...
                            alert += '<div class="text-white">';
                                alert += '<ul>';
                                    if(dispersion_total != output_total){
                                        alert += '<li>El monto total de dispersiones no puede ser diferente al monto total del movimiento: D:'+ dispersion_total +' O:'+ output_total +'</li>';
