            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Compañías</div>
                    </a>
                    <ul>
                        <li> <a href="{{ URL::route('companies') }}"><i class="bx bx-right-arrow-alt"></i>Lista</a>
                        </li>
                        <li> <a href="{{ URL::route('companies.create') }}"><i class="bx bx-right-arrow-alt"></i>Crear</a>
                        </li>
                        <li> <a href="{{ URL::route('companies.deleted') }}"><i class="bx bx-right-arrow-alt"></i>Restaurar</a>
                        </li>
                    </ul>
                </li>
