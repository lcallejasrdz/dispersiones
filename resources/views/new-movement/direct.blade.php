...
<hr/>
<form id="form-create" class="row g-3 needs-validation" method="POST" action="{{ route('direct.store') }}">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="output-disperser-input">
    </div>
    <div class="col-md-4">
...
@section("script")
    ...
    <script>
        ...
        $('#add-output').click(function(){
            ...
            if(output_company_input == '' || output_bank_destiny_input == '' || (output_type_input == '' || output_type_input == null) || (output_quantity_input == '' || isNumber(output_quantity_input) == false) || output_disperser_input == '' || output_bank_origen_input == '')
            {
                var alert = '<div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">';
                    alert += '<div class="d-flex align-items-center">';
                        alert += '<div class="font-35 text-white"><i class="bx bxs-message-square-x"></i>';
        ...
        $('#submit-btn').click(function(){
            ...
            if(customer == '' || ((entry_total == 0 || entry_total == '' || entry_total == null) || (output_total == 0 || output_total == '' || output_total == null)) || (entry_total != output_total))
            {
                var alert = '<div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">';
                    alert += '<div class="d-flex align-items-center">';
                        alert += '<div class="font-35 text-white"><i class="bx bxs-message-square-x"></i>';
                        ...
                        alert += '<div class="ms-3">';
                            ...
                            alert += '<div class="text-white">';
                                alert += '<ul>';
                                    ...
                                    if(entry_total != output_total){
                                        alert += '<li>El monto total de entrada no puede ser diferente al monto total de salida</li>';
                                    }else{
